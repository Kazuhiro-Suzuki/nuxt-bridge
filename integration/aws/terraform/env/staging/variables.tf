...
variable "monitoring_role_name" {
  type    = string
  default = "LgPwdRdsMonitoringStgRole"
}
...
variable "site_domain" {
  type    = string
  default = "https://stg.lg-pwd.jp"
}
variable "site_sub_domain" {
  type    = string
  default = "https://backend-stg.lg-pwd.jp"
}
...
variable "htp_html_url" {
  type    = string
  default = "https://temp.stg.lg-pwd.jp/index.html"
}
...
variable "backend_domain" {
  type    = string
  default = "backend-stg.lg-pwd.jp"
}
variable "temp_url_domain" {
  type    = string
  default = "temp.stg.lg-pwd.jp"
}
variable "log_bucket" {
  type    = string
...
variable "ecs_task_execution_role_name" {
  type    = string
  default = "LgPwdEcsTaskExecutionStgRole"
}
// ロールを予め作っておく必要がある
// ECS コンテナ内部のロール（アプリケーションで使う権限が必要）
variable "ecs_task_role_name" {
  type    = string
  default = "LgPwdEcsTaskStgRole"
}
// backend のコンテナイメージタグ
variable "image_tag" {
  type    = string
...
variable "aws_ses_configuration_set_name" {
  type    = string
  default = "lg-pwd-staging-configuration-set"
}
variable "tmp_dir" {
  type    = string
  default = "/tmp/lg-pwd"
...
variable "backend_url" {
  type    = string
  default = "https://api-stg.lg-pwd.jp"
}
