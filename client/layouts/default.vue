<template>
  <v-app dark>
    ...
    <v-main :style="backgroundColorStyle">
      <v-container :class="defaultContainerClass" :style="defaultContainerStyle">
    ...
    <FooterBgImage v-if="['142077', '092134'].includes(citycode)"
      :fixed="fixed"
      :copyRight="copyRight"
      :footerBaseColor="footerBaseColor"
      :footerPcImg="footerPcImg"
      :footerSpImg="footerSpImg"
      :citycode="citycode"
    />
    <Footer v-if="['131032', '131237', '212172'].includes(citycode)"
      :fixed="fixed"
      :copyRight="copyRight"
...
export default {
  ...
  computed: {
    ...
    defaultContainerStyle(){
      if(['212172'].includes(this.citycode)){
        return ''
      }
      return this.$vuetify.breakpoint.mobile ? '' : 'margin-bottom: 120px'
    },
  ...
  async created() {
    if (this.regionData && this.regionData.hasOwnProperty('city_code')) {
      ...
      if(['212172'].includes(this.citycode)){
        this.footerBaseColor = '#FAF6F0'
        this.backgroundColor = '#FAF6F0'
        this.footerClass = 'py-15 grey--text'
      }
      ...
      favicon.href = 'specific/' + this.regionData.favicon_image
  ...
  methods: {
    ...
    setLayout(regionData) {
      ...
      favicon.type = 'image/x-icon'
      favicon.rel = 'shortcut icon'
      favicon.href = 'specific/' + regionData.favicon_image
      document.getElementsByTagName('head')[0].appendChild(favicon)
    },
  },
}
