    ...
    <v-row justify="center" class="pb-md-3">
      <v-col xs="12" sm="12" md="11" lg="11" xl="11">
        <NotificationSimpleText
          :citycode="citycode"
          :item="item"
          :icon="'$IconInformation2tHex118C46'"
        />
      </v-col>
    </v-row>
    ...
    <div style="padding-top: 100px;" v-if="!$vuetify.breakpoint.mobile">
      ...
      <v-row dense>
        <v-col class="d-flex justify-end">
          <a
            href="https://play.google.com/store/apps/details?id=com.lg_pwd.nasushiobara"
            target="_blank"
          >
            <v-img
        ...
        <v-col class="d-flex justify-start">
          <a
            href="https://apps.apple.com/app/apple-store/id6478094867?mt=8"
            target="_blank"
          >
            <v-img
              src="common/ios.png"
...
.bg-top-pc-img{
  background: url("/specific/bg-top-pc-nasushiobara.png");
  background-repeat: repeat-x;
  background-position: top center;
}
.bg-top-sp-img{
  background: url("/specific/bg-top-sp-nasushiobara.png");
  background-repeat: repeat-x;
  background-position: top center;
